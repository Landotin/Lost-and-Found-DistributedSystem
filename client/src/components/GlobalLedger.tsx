...
export default function GlobalLedger({ items, loading, error, deptName, onProcessClaim }: GlobalLedgerProps) {
  ...
  // Filter items based on search, status, and department
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-900">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Origin Department</th>
            ...
            <tbody className="divide-y divide-gray-800">
              {filteredItems.map((item) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-400">{item.department_origin}</td>
